...
Looking in the ATMEGA16 datasheet, the overflow interrupt for timer 1 is obvious --- it's listed as ``TIMER1 OVF'' in the Interrupts chapter. Just like in part five, we need to replace the spaces in the vector name with underscores, and add the ``\texttt{\_vect}'' suffix to the end.
